...
\begin{document}
%\includepdf[pages={1}]{images/MS Thesis Approval -- RP}
\includepdf[pages=-,pagecommand={},width=\textwidth]{approval.pdf}
...
\includegraphics[width=4cm, height=4cm]{images/khoury.png}\\[1cm] % Include a department/university logo - this will require the graphicx package
...
\input{related.tex}
\input{wordvectors.tex}

\input{method2.tex}
\input{methodLR_wvreg.tex}
